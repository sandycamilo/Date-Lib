...
const e = new D(2017, 0, 2, 3, 4, 5)
console.log(e.format()) // 2017 January 01
console.log(e.format('y/m/d')) // 17/Jan/2
console.log(e.format('H:I:S')) // 03:04:05
console.log(e.format('h:i:s')) // 3:4:5
console.log(e.format('Y-M-D h:I:S')) // 2017-January-02 3:04:05
console.log(e.format('W: w')) 
const f = new D(2019, 0, 2, 3, 4, 5)
console.log(f.when()) 
const g = new D(2019, 9, 2, 3, 4, 5)
console.log(g.when()) 
const h = new D(2044, 9, 2, 3, 4, 5)
console.log(h.when())
const k = new D(2020, 6, 30, 3, 4, 5)
console.log(k.when()) 
const l = new D()
console.log(l.when()) // today
